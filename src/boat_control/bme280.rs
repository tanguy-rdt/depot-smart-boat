...
impl BME280 {
    ...
    pub fn get_temperature(&mut self, gpio: &Gpio) -> f32{
        ...
        let temperature_in_c: f32 = (self.compensation_temperature(temp_raw, gpio)) as f32 / 100.0;

        temperature_in_c
    }

    fn compensation_temperature(&mut self, temp_raw: i32, gpio: &Gpio) -> i32 {
    ...
    pub fn get_pressure(&self, gpio: &Gpio) -> f32{
        ...
        let pressure_in_pa = (self.compensation_pressure(press_raw, gpio) as f32)/256.0;

        pressure_in_pa
    }

    fn compensation_pressure(&self, press_raw: i32, gpio: &Gpio) -> u32{
    ...
    pub fn get_humidity(&self, gpio: &Gpio) -> f32{
        ...
        let hum_in_percent = (self.compensation_humidity(hum_raw as i32, gpio) as f32)/1024.0;

        hum_in_percent
    }

    fn compensation_humidity(&self, hum_raw: i32, gpio: &Gpio) -> i32{
